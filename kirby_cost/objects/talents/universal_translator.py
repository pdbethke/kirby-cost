"""
Universal Translator Talent for kirby-cost.

Converted from com.hero.objects.talents.UniversalTranslator.java

Universal Translator allows understanding and speaking any language.
"""
...
class UniversalTranslator(Talent, xmlid="UNIVERSAL_TRANSLATOR"):
    """
    Universal Translator Talent.
    
    Allows understanding and speaking any language.
    Can be based on different characteristics.
    """
    
    def __init__(self, element=None):
        """Initialize a Universal Translator talent."""
        super().__init__(element, self.XMLID)
        self.characteristic: int = 5  # Default to INT
    ...
    def get_save_xml(self):
        ...
        Returns:
            XML element with characteristic and levels attributes
        """
    ...
    def _init(self, element) -> None:
        ...
        """
        self._display = "Universal Translator"
        self._base_cost = 20.0
        self._level_cost = 1.0
        self._level_value = 1.0
        self.exclusive = True
        self.characteristic_choices = []
        self.characteristic = 5  # Default to INT
