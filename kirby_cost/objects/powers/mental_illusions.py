"""
Mental Illusions power class for kirby-cost.

Converted from com.hero.objects.powers.MentalIllusions.java

Power to create mental illusions.
"""

from kirby_cost.objects.powers.power import Power


class MentalIllusions(Power, xmlid="MENTALILLUSIONS"):
    """
    Mental Illusions power.
    
    Creates illusions in target's mind.
    """
    
    def __init__(self):
        """Initialize a Mental Illusions power."""
        super().__init__()
        self.xmlid = MentalIllusions.XMLID
        self._duration = "INSTANT"
    
    @property
    def damage_display(self) -> str:
        """Get mental illusions display."""
