"""
Mind Control power class for kirby-cost.

Converted from com.hero.objects.powers.MindControl.java
...
class MindControl(Power, xmlid="MINDCONTROL"):
    """
    Mind Control power.
    
    Power to control the actions of others.
    """
    
    def __init__(self):
        """Initialize a Mind Control power."""
        super().__init__()
        self.xmlid = MindControl.XMLID
        self._duration = "INSTANT"
    
    @property
    def damage_display(self) -> str:
        """Get mind control display."""
