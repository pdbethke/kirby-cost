"""
Ranged Damage Classes for Martial Arts.

Converted from com.hero.objects.martialarts.RangedDamageClasses.java

Ranged Damage Classes add ranged damage classes to martial arts maneuvers.
"""
...
class RangedDamageClasses(GenericObject, xmlid="RANGEDDC"):
    """
    Ranged Damage Classes.
    
    Adds ranged damage classes to martial arts maneuvers.
    """
    
    def __init__(self, element=None, bl: bool = False):
        """
        Initialize Ranged Damage Classes.
    ...
    def _init(self, element) -> None:
        ...
        """
        self._display = "+[LVL] Ranged Damage Class(es)"
        self._alias = ""
        self._base_cost = 0.0
    ...
    def get_save_xml(self):
        ...
        Returns:
            XML element with RANGEDDC tag
        """
        element = super().get_save_xml()
        element.tag = "RANGEDDC"
        return element
