"""
RangeBasedOnSTR modifier for kirby-cost.

Converted from com.hero.objects.modifiers.RangeBasedOnSTR.java

RangeBasedOnSTR modifier with custom included() method.
Validates range and power type requirements. Uses base class getColumn2Output() method.
"""
...
class RangeBasedOnSTR(Modifier, xmlid="RANGEBASEDONSTR"):
    """
    RangeBasedOnSTR modifier.
    
    Range is based on STR.
    """
    
    def __init__(self, element=None):
        """Initialize a RangeBasedOnSTR modifier."""
        super().__init__()
