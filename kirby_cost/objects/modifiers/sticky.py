"""
Sticky modifier for kirby-cost.

Converted from com.hero.objects.modifiers.Sticky.java

Sticky modifier with custom getColumn2Output() and included() methods.
Validates target requirements and Based On CON for Mental Powers.
"""
...
class Sticky(Modifier, xmlid="STICKY"):
    """
    Sticky modifier.
    
    Power effect sticks to target.
    
    Has custom validation for target requirements and Based On CON for Mental Powers.
    """
    
    def __init__(self, element=None):
        """Initialize a Sticky modifier."""
        super().__init__()
    ...
    def column2_output(self) -> str:
        ...
        Custom formatting for Sticky modifier.
        """
        string = ""
        string2 = ""
