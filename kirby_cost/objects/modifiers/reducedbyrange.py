"""
ReducedByRange modifier for kirby-cost.

Converted from com.hero.objects.modifiers.ReducedByRange.java

ReducedByRange modifier with custom included() method.
...
class ReducedByRange(Modifier, xmlid="REDUCEDBYRANGE"):
    """
    ReducedByRange modifier.
    
    Reduces power effectiveness by range.
    """
    
    def __init__(self, element=None):
        """Initialize a ReducedByRange modifier."""
        super().__init__()
